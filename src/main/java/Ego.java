...
public class Ego {
     ...
     */
    public void addTask(String input) throws EgoException {
        Task newTask = null;
        ...
        System.out.println("Now you have " + this.tasks.getSize() + " tasks to complete!");
        printLine();
    }
    ...
    public void listTasks() {
        ...
        for (int i = 0; i < this.tasks.getSize(); i++) {
            int count = i + 1;
            System.out.println(count + "." + this.tasks.getTask(i));
        }
        printLine();
    }
     ...
     */
    public void markTask(int taskNum) throws EgoException {
        ...
        printLine();
        System.out.println(msg + this.tasks.getTask(taskNum - 1));
        printLine();
    }
     ...
     * @param taskNum the number to identify the task based on the list
     */
    public void unmarkTask(int taskNum) throws EgoException {
        if (taskNum <= 0 || taskNum > this.tasks.getSize()) {
            throw new EgoException("Wow! Please input a number from 1 to " + this.tasks.getSize());
        }
    ...
    public void deleteTask(int taskNum) throws EgoException {
        if (taskNum <= 0 || taskNum > this.tasks.getSize()) {
            throw new EgoException("Wow! Please input a number from 1 to " + this.tasks.getSize());
        }
